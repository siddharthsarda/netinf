...
public:
  ...
  static void PlotValV(const TVec<TPair<TVal1, TVal2> >& ValV, const TStr& OutFNmPref, const TStr& Desc="",
   ...
   const TGpSeriesTy& SeriesTy=gpwLinesPoints, const bool& sortV=true);
  template <class TVal1, class TVal2>
  ...
  static void PlotValMomH(THash<TVal1, TMom>& ValMomH, const TStr& OutFNmPref, const TStr& Desc="",
   ...
   bool PlotAvg=true, bool PlotMed=true, bool PlotMin=false, bool PlotMax=false, bool PlotSDev=true, bool PlotStdErr=false);
...
void TGnuPlot::PlotValV(const TVec<TPair<TVal1, TVal2> >& ValV, const TStr& OutFNmPref, const TStr& Desc,
 const TStr& XLabel, const TStr& YLabel, const TGpScaleTy& ScaleTy, const bool& PowerFit, const TGpSeriesTy& SeriesTy, const bool& sort) {
