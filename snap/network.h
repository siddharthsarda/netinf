...
/////////////////////////////////////////////////
// Node Edge Data Network (TNGraph with data on nodes and edges)
...
public:
  ...
  public:
    ...
    TEdgeData& GetDat(const int& EdgeN) { return CurNode.GetOutEDat(CurEdge); }
    const TEdgeData& GetDat(const int& EdgeN) const { return CurNode.GetOutEDat(CurEdge); }
