...
template <class PGraph> int GetUniqUndirEdges(const PGraph& Graph);
template <class PGraph> int GetUniqDirEdges(const PGraph& Graph);
template <class PGraph> int GetUniqBiDirEdges(const PGraph& Graph);
